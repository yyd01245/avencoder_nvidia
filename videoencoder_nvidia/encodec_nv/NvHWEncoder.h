...
#ifndef _H_NVHWENCODER_
#define _H_NVHWENCODER_
...
public:
    ...
    GUID                                                 GetProfileGUID(char* encoderPreset, int codec);
